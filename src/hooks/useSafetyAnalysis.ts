...
export function useSafetyAnalysis() {
  ...
  const getRegulationByDeficiencyType = (deficiencyType: string): { article: string; content: string } => {
    const regulationMap: Record<string, { article: string; content: string }> = {
      ...
      '職災通報': {
        article: '《職業安全衛生法施行細則》第47條',
        content: '雇主應於八小時內通報勞動檢查機構，指事業單位明知或可得而知已發生規定之職業災害事實起八小時內，應向其事業單位所在轄區之勞動檢查機構通報。'
      },
      '風險評估': {
        article: '《職業安全衛生法施行細則》第8條',
        content: '雇主明知或可得而知勞工所從事之工作，有致其生命、身體及健康受危害之虞，應可採取必要之預防設備或措施。風險評估指辨識、分析及評量風險之程序。'
      },
      '危險性工作場所': {
        article: '《職業安全衛生法施行細則》第22條',
        content: '丁類危險性工作場所包括：建築物頂樓樓板高度50公尺以上、橋墩中心距離50公尺以上、壓氣施工、隧道長度1000公尺以上、開挖深度18公尺以上且面積500平方公尺等工程。'
      },
      '協議組織': {
        article: '《職業安全衛生法施行細則》第38條',
        content: '協議組織應由原事業單位召集，定期或不定期協議安全衛生管理、危險作業管制、機械設備入場管制、作業人員進場管制、變更管理等事項。'
      },
      '承攬告知': {
        article: '《職業安全衛生法施行細則》第36條',
        content: '事前告知應以書面為之，或召開協商會議並作成紀錄。'
      },
      '作業環境監測': {
        article: '《職業安全衛生法施行細則》第17條',
        content: '為掌握勞工作業環境實態與評估勞工暴露狀況，應訂定作業環境監測計畫並實施監測，包括噪音、粉塵、有機溶劑等作業場所。'
      },
    };
